...
chown -R ${INVOICEPLANE_USER}:${INVOICEPLANE_USER} ${INVOICEPLANE_INSTALL_DIR}/application/config/
chown -R ${INVOICEPLANE_USER}:${INVOICEPLANE_USER} ${INVOICEPLANE_INSTALL_DIR}/application/helpers/mpdf/tmp/
chown -R ${INVOICEPLANE_USER}:${INVOICEPLANE_USER} ${INVOICEPLANE_INSTALL_DIR}/application/helpers/mpdf/ttfontdata/
chown -R ${INVOICEPLANE_USER}:${INVOICEPLANE_USER} ${INVOICEPLANE_INSTALL_DIR}/application/helpers/mpdf/graph_cache/
chown -R ${INVOICEPLANE_USER}:${INVOICEPLANE_USER} ${INVOICEPLANE_INSTALL_DIR}/application/logs/
